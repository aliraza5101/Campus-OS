...
import opportunitiesRoutes from './server/routes/opportunities';
...
// Mount Modular API Routes backed by Supabase
...
function resolveAIProvider(): {
  ...
  if (groqKey && groqKey.startsWith('xai-')) {
    return { provider: 'grok', key: groqKey, name: 'Grok AI (xAI)' };
  }
  if (geminiKey) {
